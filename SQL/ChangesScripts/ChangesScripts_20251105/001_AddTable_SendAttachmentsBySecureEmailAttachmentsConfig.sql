...
CREATE TABLE [dbo].[SendAttachmentsBySecureEmailAttachmentsConfig](
	...
	,[EmailFromAddress] [nvarchar] (500) NOT NULL  
    ...
    ,[EmailWebApiUrl] [nvarchar] (255) NOT NULL 
...
INSERT INTO [dbo].[SendAttachmentsBySecureEmailAttachmentsConfig]
     ...
     VALUES
           ...
           ,'[Secure] Summit Healthcare Talkiatry document(s)'
           ,'Html'
           ,'Please review the following Summit Healthcare Talkiatry document(s) attached:'
           ,'Thanks.<br>Philip Morrison<br>Summit Healthcare<br>IT Business Intelligence'
